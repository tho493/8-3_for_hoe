...
const messages = [
    "Mặc dù không quá đặc biệt, nhưng anh gửi em vài lời chúc nho nhỏoo",
    "Mong rằng mỗi ngày của em đều đầy ắp niềm vui",
    "Và chúc em luôn mạnh mẽ, tự tin và luôn đạt được những điều mình mong muốn!"
];
